		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aerolineas TEDN",
									"targetURL": "#aerolineastedn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aerolineastedn-display": {
								"semanticObject": "aerolineastedn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aerolineastedn",
									"url": sap.ui.require.toUrl("aerolineastedn")
								}
							}
						}
					}
